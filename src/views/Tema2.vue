  ...
  .container.container01.px-4.px-md-5.pt-4
    .titulo-principal.color-acento-contenido(data-aos="fade-right")
      .titulo-principal__numero
        span.text-white 2
      h1 Habeas data y normatividad vigente
      ...
      .col-md-10.BG01.p-3
        .row.justify-content-end.align-items-center
          ...
          .col-md-10.col-12(data-aos="fade-left")    
            p.mb-0 <span style="background-color:#ECE5F7 !important; font-weight: bold;">Cuando las empresas usan datos personales para aplicar técnicas y tareas de <em>marketing</em> deberán valorar aspectos éticos</span><span style="color:#7F4FC7 !important; font-weight: bold;">(Ronda, 2013). </span> Aquí se tiene la capacidad de ahondar y conocer los pensamientos más profundos y privados de los consumidores deberá realizarse de forma transparente y destinando la información obtenida a la creación de productos y servicios que satisfagan las necesidades y deseos reales de los consumidores. <b>Además, permite conocer las rutas y hábitos para la decisión de compra teniendo la susceptibilidad de ser manipulado y, asimismo, evitar publicar anuncios engañosos o abusivos aprovechando la vulnerabilidad o necesidad de algún grupo poblacional</b>. Es importante anotar que los procesos de información deben tener autorización por parte de los implicados.

    separador

    #t_2_1.titulo-segundo.color-acento-contenido.ms-5(data-aos="fade-right")
      h2 2.1.	Manejo de la información personal - Habeas data

  .container.BGIMG02.pe-5.pt-4
      ...
      .col-md-10.BG02.p-4
        .row.justify-content-start.align-items-center
          .col-md-8.col-12.order-md-1.order-2(data-aos="fade-right")
            ...
            p.mb-5 La normatividad en Colombia está sustentada en la Ley 126 de 2008, en diversas sentencias posteriores de la Corte y otras disposiciones que van actualizando la ley a medida de las necesidades.
          .col-md-4.col-6.p-0.mb-md-0.mb-4.order-md-2.order-1.img03
            figure(data-aos="fade-left")
              img(src='@/assets/curso/tema2/img03.png')
        
      .row.mb-4.top01
        .col-1
        .col-md-7.cajon.color-acento-botones.p-3
          p.text-bold.mb-0 Es importante tener en cuenta algunos concretos que se encuentran en la norma, según la Superintendencia de Industria y Comercio (2021), a saber:
